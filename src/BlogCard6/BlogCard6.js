...
export default function BlogCard6() {
    return (
        <div className="blogCard6">
            <div className="blogCard6Container">
                <img className="blogCard6Img" src="https://images.unsplash.com/photo-1593642533144-3d62aa4783ec?ixid=MnwxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1650&q=80" />
            </div>
            <div className="blogCard6Content">
                <h1 className="blogCard6Heading">card title</h1>
            </div>
            <div>
                <p className="blogCard6Para">
