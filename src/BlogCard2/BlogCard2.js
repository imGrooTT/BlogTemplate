    ...
    return (
        <div>
            <div className="blogCard2">
                <div className="">
                    <img className="blogCard2Img" src="https://cdn2.hubspot.net/hubfs/322787/Mychefcom/images/BLOG/Header-Blog/photo-culinaire-pexels.jpg" />
                </div>
                <div className="card">
                    <br />
                    <br />
                    <br />
                    <h1 className="blogCard2Heading">Why you Need More Magnesium in Your Daily Diet</h1>
                    <hr />
                    <div className="">
                        <p>
