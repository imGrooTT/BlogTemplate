...
// import './BlogCard7.css'
import ReactHtmlParser from 'react-html-parser';

export default function BlogCard7() {
    const Blogcard7=` <div class="blogCard7">
    <div class="blogCard7Header">
        <h1 class="blogCard7Heading">Get &nbsp; <span class="blogCard7Word"> insights &nbsp;</span>  that help your business grow.</h1>
    </div>
    <div>
        <p class="blogCard7Para">
