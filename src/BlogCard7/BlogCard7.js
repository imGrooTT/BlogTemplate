...
export default function BlogCard7() {
    return (
        <div className="blogCard7">
            <div className="blogCard7Header">
                <h1 className="blogCard7Heading">Get &nbsp; <span className="blogCard7Word"> insights &nbsp;</span>  that help your business grow.</h1>
            </div>
            <div>
                <p className="blogCard7Para">
