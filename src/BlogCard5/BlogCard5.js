...
export default function BlogCard5() {
    return (
        <div className="blogCard5">
            <div className="blogCard5Header">
                {/* <img className="blogCard5img" /> */}
                <h1 className="blogCard5Heading">Avokado Ezmeli Taco</h1>
            </div>
            <div className="blogCard5Content">
                <img className="blogCard5img" src="https://www.acouplecooks.com/wp-content/uploads/2020/06/Avocado-Tacos-016.jpg" />
            </div>
            <div>
                <p className="blogCard5Para">
